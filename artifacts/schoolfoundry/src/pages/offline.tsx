      ...
      <section className="py-16 sm:py-24 bg-[#07090E]">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/10 border border-white/10 rounded-2xl overflow-hidden">
            ...
            <div className="bg-[#07090E] p-7 cursor-default hover:bg-white/[0.03] transition-colors">
              ...
              <div className="p-7 group-hover:bg-white/[0.03] transition-colors">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-[13px] text-white/50 leading-[1.6]">Get quick answers on collections, outstanding fees, and payment trends.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/10 border border-white/10 rounded-2xl overflow-hidden">
            {[
              ...
              <div key={idx} className="bg-[#07090E] group cursor-default">
                <div className="p-7 group-hover:bg-white/[0.03] transition-colors">
